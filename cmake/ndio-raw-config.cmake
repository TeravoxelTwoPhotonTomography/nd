...
set(NDIO_RAW_GIT_REPOSITORY ssh://git@bitbucket.org/nclack/ndio-raw.git CACHE STRING "Location of the git repository for ndio-raw.")
ExternalProject_Add(ndio-raw-plugin
  GIT_REPOSITORY ${NDIO_RAW_GIT_REPOSITORY}
  LIST_SEPARATOR ^^
...
ExternalProject_Get_Property(ndio-raw-plugin INSTALL_DIR)

add_library(ndio-raw MODULE IMPORTED)
set(plugin ndio-raw)
set_target_properties(${plugin} PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES "C"
  IMPORTED_LOCATION "${INSTALL_DIR}/bin/plugins/${CMAKE_SHARED_MODULE_PREFIX}${plugin}${CMAKE_SHARED_MODULE_SUFFIX}"
)
add_dependencies(ndio-raw libnd)

### install plugins to parent project plugins
get_target_property(_path ndio-raw IMPORTED_LOCATION)
install(FILES ${_path} DESTINATION bin/plugins)

### exit variables
set(ND_ndio-raw_FOUND TRUE)
