...
set(NDIO_SERIES_GIT_REPOSITORY ssh://git@bitbucket.org/nclack/ndio-series.git CACHE STRING "Location of the git repository for ndio-series.")
ExternalProject_Add(ndio-series-plugin
  GIT_REPOSITORY ${NDIO_SERIES_GIT_REPOSITORY}
  LIST_SEPARATOR ^^
...
ExternalProject_Get_Property(ndio-series-plugin INSTALL_DIR)

add_library(ndio-series MODULE IMPORTED)
set(plugin ndio-series)
set_target_properties(${plugin} PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES "C"
  IMPORTED_LOCATION "${INSTALL_DIR}/bin/plugins/${CMAKE_SHARED_MODULE_PREFIX}${plugin}${CMAKE_SHARED_MODULE_SUFFIX}"
)
add_dependencies(ndio-series libnd)

### install plugins to parent project plugins
get_target_property(_path ndio-series IMPORTED_LOCATION)
install(FILES ${_path} DESTINATION bin/plugins)

### exit variables
set(ND_ndio-series_FOUND TRUE)
