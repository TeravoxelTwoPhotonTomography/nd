...
if(WIN32)
  set(GTEST_USE_SHARED TRUE)
endif()

if(GTEST_USE_SHARED)
  set(EP_EXTRA_CMAKE_ARGS -DBUILD_SHARED_LIBS:BOOL=TRUE)
endif()
...
show(GTEST_ROOT_DIR)
if(GTEST_USE_SHARED)
set_property(TARGET libgtest PROPERTY IMPORTED_LOCATION      ${GTEST_ROOT_DIR}/${CMAKE_CFG_INTDIR}/${CMAKE_SHARED_LIBRARY_PREFIX}gtest${CMAKE_SHARED_LIBRARY_SUFFIX})
set_property(TARGET libgtest-main PROPERTY IMPORTED_LOCATION ${GTEST_ROOT_DIR}/${CMAKE_CFG_INTDIR}/${CMAKE_SHARED_LIBRARY_PREFIX}gtest_main${CMAKE_SHARED_LIBRARY_SUFFIX})
else()
