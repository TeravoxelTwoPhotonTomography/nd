...
#
find_package(SZIP CONFIG PATHS cmake)
find_package(ZLIB CONFIG PATHS cmake)
...
set_target_properties(hdf5 PROPERTIES
  ...
  IMPORTED_LOCATION         "${HDF5_ROOT_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}hdf5${CMAKE_STATIC_LIBRARY_SUFFIX}"
  IMPORTED_LOCATION_RELEASE "${HDF5_ROOT_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}hdf5${CMAKE_STATIC_LIBRARY_SUFFIX}"
  IMPORTED_LOCATION_DEBUG   "${HDF5_ROOT_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}hdf5_debug${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )
